...
public class IncompleteFormListAdapter extends RecyclerView.Adapter<IncompleteFormListAdapter.ViewHolder> {
    Context mContext;
    ...
    public IncompleteFormListAdapter(ArrayList<CompleteFormQnA> mDetails, ArrayList<CompleteFormQnA> childIdList, Context mContext, String id, int form_id) {
